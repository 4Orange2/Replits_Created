...
def search_spaces(row_and_column, index_of_word, coming_from_coordinate, bend_status): # nothing is wrong in this fucntion
    ...
    if matrix[coordinate[0]][coordinate[1]] == desired_letter: # where coordinate[0] is the row and coordinate[1] is the column
      ...
      if index_of_word == last_index:
        ...
        if len(coordinate) == 3:
          ...
          search_spaces(coordinate, index_of_word + 1, row_and_column, bend_status)
...
print(f"these are how many occurences that I found of the word: {word_is_present}")